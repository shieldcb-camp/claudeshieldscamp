...
// NOTE: elite is now set to the LIVE-mode Price ID — this must be paired
// with STRIPE_SECRET_KEY set to your sk_live_... key in Netlify, or every
// checkout attempt will fail with "No such price" (test/live mismatch).
const PRICE_IDS = {
