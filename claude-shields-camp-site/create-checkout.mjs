...
// NOTE: elite is currently set to the TEST-mode Price ID for end-to-end
// testing. The LIVE-mode Elite Camp Price ID is price_1U1BR3Hk8x31lRhs60JXAT6l —
// swap it in here (and set STRIPE_SECRET_KEY to your sk_live_... key in
// Netlify) together, once testing is confirmed working.
const PRICE_IDS = {
